...
The npm installer writes `tmc` and `tmcopilot` to the first writable directory it can use from your `PATH`. Set `TMC_INSTALL_DIR` when you want a specific install location:
